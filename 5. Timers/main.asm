...
.def    counter         = r18
.equ    F_CPU           = 8000000
.equ    Prescaler       = 1024                  ; Don't forget to match the setting below for CS0
.equ    TargetHz        = 50                    ; 50Hz === 20ms period
.equ    TOP             = 156                   ;(8000000/Prescaler)/TargetHz
.equ    dutycycle       = 5;                   ; 5<-->16 max range. 0.8ms <--> 2.2ms
.equ    ON              = 1
.equ    OFF             = 0
.equ    stepWait        = 10
